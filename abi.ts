/**
 * PrizePoolEscrow Smart Contract
 * 
 * Network: Base (Chain ID: 8453)
 * Contract Address: 0xFe3989D74711b1dda30cf4a52F3DE14392185097
 * 
 * This contract manages multi-signature escrow for hackathon and grant prize pools.
 * Supports secure prize distribution with role-based access control and time-locked emergency withdrawals.
 */
...
/**
 * Pool Status Enum
 * Matches the solidity enum PrizePoolEscrow.PoolStatus
 */
...
/**
 * Payout Status Enum
 * Matches the solidity enum PrizePoolEscrow.PayoutStatus
 */
...
export const ROLES = {
  ...
  HOST_ROLE: '0xa49807205ce4d355092ef5a8a18f56e8913cf4a201fbe287825b095693c21775',
  JUDGE_ROLE: '0x4d5b6e4f5579f6bb4c9a34b4f1e4f1b2b3c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8',
...
export const CONTRACT_CONSTANTS = {
  EMERGENCY_TIMELOCK: 7 * 24 * 60 * 60, // 7 days in seconds
...
export const CONTRACT_CONFIG = {
  address: PRIZE_POOL_ESCROW_ADDRESS,
  abi: PRIZE_POOL_ESCROW_ABI,
  network: 'base',
  chainId: 8453,
